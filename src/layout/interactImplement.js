...
function showModal(platform, title, content, type) {
  if (platform === "PC") {
    ...
    Dialog.alert({
      ...
      message: content,
      theme: "round-button",
      confirmButtonText: type === INTERACT_MSG_TYPE.ERROR ? "真遗憾" : "好的",
    });
  }
}
